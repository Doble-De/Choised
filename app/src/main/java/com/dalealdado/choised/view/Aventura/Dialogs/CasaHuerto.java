...
public class CasaHuerto {

    TextView name, texto;
    ImageView pj, npc, next;
    Button opcion1, opcion2;
    int cont=0;
    String[] historia = {"Hola, lo siento pero la tierra está sin minerales.", "Podrías haber plantado unas buenas verduras.","Bueno, tampoco es que me gusten mucho.", "He dejado unas semillas para que pruebes como se hace.","Bueno, igual me paso."};


    public CasaHuerto(final Context context){
    ...
    void turnonpc(){
        ...
        npc.setImageResource(R.drawable.viejo);
        name.setText("Señor del Huerto");
