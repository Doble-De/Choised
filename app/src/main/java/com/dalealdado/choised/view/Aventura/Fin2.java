...
public class Fin2 extends AppCompatActivity {
    ...
    ImageView pj, oro1, oro2, oro3, oro4, oro5, oro6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oro1 = findViewById(R.id.oro2);
        oro2 = findViewById(R.id.oro3);
        oro3 = findViewById(R.id.oro4);
        oro4 = findViewById(R.id.oro5);
        oro5 = findViewById(R.id.oro6);
        oro6 = findViewById(R.id.oro7);

        imagenProta();
        oro1.setImageResource(R.drawable.gold);
        oro2.setImageResource(R.drawable.gold);
        oro3.setImageResource(R.drawable.gold);
        oro4.setImageResource(R.drawable.gold);
        oro5.setImageResource(R.drawable.gold);
        oro6.setImageResource(R.drawable.gold);
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Fin2.this, MainActivity.class));
            }
        });
    }
